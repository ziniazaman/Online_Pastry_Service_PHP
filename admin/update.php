	...
	<table>
		<form action="update.php?package_id=<?=$package_id?>" method="post" style="padding: 20px 58px" onsubmit="return updateChack()">
					<tr><td><h1><u>Package Name:</u></h1></td>
						<?php
							$query0=mysqli_query($con,"SELECT package_name FROM package where package_id='".$package_id."'");
					...
					<td><?php
					$query1=mysqli_query($con,"SELECT item_name FROM item where package_id='".$package_id."'");
					...
					<tr>
					<?php
						$query2=mysqli_query($con,"SELECT package_price FROM package where package_id='".$package_id."'");
				...
				<tr>					
					...
					<td>
							<?php
								$query3=mysqli_query($con,"SELECT day_name FROM day where package_id='".$package_id."'");
