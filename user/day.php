...
if(!isset($_SESSION['sess_user']))
{
	...
	//$query=mysql_query($con,"SELECT * FROM registration where username='".$user."'" );
...
<div class="main">
		...
		<h1><u>Package List:</u></h1>
					...
					<?php 
						...
						$query=mysqli_query($con,"SELECT * FROM package JOIN day ON package.package_id=day.package_id where day.day_name='".$day_name."'");		
